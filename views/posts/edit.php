...
<div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Редактировать пост</h1>
    ...
    <form method="POST" action="/posts/<?= $post->id ?>/edit" class="space-y-4">
        <div>
            ...
            <input 
                ...
                id="title" 
                name="title" 
                value="<?= htmlspecialchars($title ?? $post->title) ?>"
        ...
        <div>
            ...
            <textarea 
                ...
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
            ><?= htmlspecialchars($content ?? $post->content) ?></textarea>
        </div>
